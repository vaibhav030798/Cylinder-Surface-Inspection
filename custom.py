...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            name_dict = {"full body": 1, "Dent": 2} #,"xyz": 3}
            # key = tuple(name_dict)
...
def train(model):
    ...
    dataset_train.load_custom(r"C:\Users\MSI 1\OneDrive\Desktop\instence_segmentation\dataset","train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom(r"C:\Users\MSI 1\OneDrive\Desktop\instence_segmentation\dataset", "val")
    dataset_val.prepare()
